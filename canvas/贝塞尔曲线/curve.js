...
{//获取鼠标在canvas上的坐标  
    var rect = canvas.getBoundingClientRect();   alert(canvas.width / rect.width);
    return {   
...
{  //debugger;
    ...
    cxt.beginPath();  
    cxt.arc(mousePos(e,c).x,mousePos(e,c).y,15,0,Math.PI*2,true);  
   // cxt.arc(getCanvasPos(c,e).x,getCanvasPos(c,e).y,15,0,Math.PI*2,true);  //debugger;
    cxt.closePath();  
    cxt.fill();  
}  */
 (function(){
